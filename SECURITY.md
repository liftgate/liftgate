...
- Exposure of environment variable values, API tokens, session ids, registry credentials or GitHub App keys, OAuth client secrets, SMTP credentials in responses, logs, images or the database.
